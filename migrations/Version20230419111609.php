 ...
 */
final class Version20230419111609 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE product ADD category_id INT DEFAULT NULL, DROP category_id_id');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE product ADD category_id_id INT NOT NULL, DROP category_id');
